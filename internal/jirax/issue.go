...
type IssueFields struct {
	...
	DescriptionPlain              string                 `json:"description_plain,omitempty" structs:"description_plain,omitempty"`
...
type Comment struct {
	...
	BodyPlain    string                 `json:"body_plain,omitempty" structs:"body_plain,omitempty"`
